   ...
   <section
       ...
       >
         ...
         index % 2 === 0 ? "sm:justify-start" : "sm:justify-end"
           ...
           ${index % 2 === 0 ? "sm:mr-[60%]" : "sm:ml-[60%]"}
         `}
               >
                 {/* Flex container for image and text */}
                 <div className="relative flex items-center space-x-6">
                   {/* School Logo/Image */}
                   <div className="absolute left-2 w-16 h-16 bg-white rounded-full overflow-hidden shadow-md">
                     <img
                       src={edu.img}
                       alt={edu.school}
                       className="w-full h-full object-cover rounded-full"
                   ...
                   <div className="flex flex-col justify-between pl-16">
                     <div>
                       ...
                       <h4 className="text-md sm:text-sm text-gray-300">
                         School/College: {edu.school}
                       </h4>
                     </div>
                     {/* Date at the bottom */}
                     <p className="text-sm text-gray-200 mt-2">{edu.date}</p>
                   </div>
                 </div>
